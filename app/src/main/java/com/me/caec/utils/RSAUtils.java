...
//        Cipher cipher = Cipher.getInstance(keyFactory.getAlgorithm());
     ...
     * @throws Exception
     */
    public static String encodeByModAndExp(String data, String modulus, String exponent)
            throws Exception {
        PublicKey publicKey = RSAUtils.getPublicKey(modulus, exponent);
        byte[] bytes = RSAUtils.encryptByPublicKey(data.getBytes(), Base64Utils.encode(publicKey.getEncoded()));
