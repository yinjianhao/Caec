...
public class ModifyPsdActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getImageCode(String phone) {
        x.image().bind(ivImgCode, RequestUrl.IMAGE_CODE_URL + "?phone=" + phone + "&_=" + Math.random());
    }
    ...
    private void sendMsgCode() {
        RequestParams params = new RequestParams(RequestUrl.MSG_CODE_URL);
    ...
    private void checkMsgCode() {
        RequestParams params = new RequestParams(RequestUrl.CHECK_MSG_CODE_URL);
        params.addQueryStringParameter("phone", phone);
